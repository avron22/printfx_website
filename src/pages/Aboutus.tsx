...
const testimonials: Testimonial[] = [
  {
    quote:
      "Printf FX transformed our brand identity with their exceptional printing quality. The attention to detail and customer service exceeded all expectations.",
    name: "John Doe",
    role: "CEO",
  ...
  {
    quote:
      "Working with this team has been an absolute pleasure. Their expertise in signage solutions helped our business stand out in a competitive market.",
    name: "Sarah Chen",
  ...
  {
    quote:
      "The quality of work and dedication to meeting deadlines is unmatched. They've become our go-to partner for all printing and signage needs.",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 pt-24">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 md:px-8 py-20 md:py-32 relative z-10 text-center">
          ...
          <p className="max-w-3xl mx-auto text-slate-300 leading-relaxed text-base md:text-lg px-4 mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 max-w-6xl mx-auto mb-12">
            ...
            <div className="group relative bg-gradient-to-br from-emerald-500/20 to-slate-700/50 rounded-3xl overflow-hidden shadow-2xl h-64 md:h-80 backdrop-blur-sm border border-slate-700/50 transition-all duration-500 hover:scale-105 hover:shadow-emerald-500/20">
              <div className="absolute top-8 md:top-12 left-8 md:left-12 w-12 h-12 md:w-16 md:h-16 bg-emerald-400 rounded-full opacity-80 group-hover:opacity-100 transition-opacity" />
              <div className="absolute top-16 md:top-20 right-16 md:right-20 w-8 h-8 md:w-12 md:h-12 bg-emerald-300 rounded-full opacity-60" />
            ...
            <div className="group relative bg-gradient-to-br from-blue-500/20 to-slate-700/50 rounded-3xl overflow-hidden shadow-2xl h-64 md:h-80 backdrop-blur-sm border border-slate-700/50 transition-all duration-500 hover:scale-105 hover:shadow-blue-500/20">
              <div className="absolute top-12 md:top-16 right-12 md:right-20 w-10 h-10 md:w-12 md:h-12 bg-blue-400 rounded-full opacity-80 group-hover:opacity-100 transition-opacity" />
              <div className="absolute bottom-20 left-12 w-8 h-8 bg-blue-300 rounded-full opacity-60" />
              <svg className="absolute bottom-0 left-0 w-full transition-all duration-500 group-hover:translate-y-2" viewBox="0 0 400 300" preserveAspectRatio="none">
              ...
              return (
                <div key={i} className="group text-center">
                  <div className="bg-white border-2 border-slate-200 rounded-3xl p-6 md:p-8 h-44 md:h-52 flex flex-col items-center justify-center transition-all duration-500 group-hover:bg-gradient-to-br group-hover:from-emerald-500 group-hover:to-emerald-600 group-hover:border-emerald-500 cursor-pointer group-hover:scale-105 group-hover:shadow-xl group-hover:shadow-emerald-500/30">
                    <Icon className="w-12 h-12 md:w-14 md:h-14 transition-all duration-300 stroke-slate-800 group-hover:stroke-white mb-4" strokeWidth={2.5} />
                    <h3 className="text-center mt-2 text-base md:text-lg font-semibold text-slate-800 group-hover:text-emerald-600 transition-colors">{feature.title}</h3>
                  </div>
                </div>
              );
            })}
                ...
                {testimonials.map((t, idx) => (
                  <div key={idx} className="w-full flex-shrink-0 px-4 md:px-8">
                    <div className="bg-white shadow-2xl rounded-3xl p-8 md:p-12 flex flex-col items-center border border-slate-100 hover:shadow-emerald-500/10 transition-shadow duration-300">
                      ...
                      <h4 className="font-bold text-slate-900 text-lg md:text-xl">{t.name}</h4>
                      <span className="text-emerald-600 text-sm md:text-base font-medium">{t.role}</span>
                    </div>
                  </div>
                ))}
              </div>
      ...
      <section className="bg-gradient-to-b from-slate-50 to-white py-16 md:py-24">
        <div className="container mx-auto px-6 md:px-8 text-center">
          ...
          <p className="max-w-2xl mx-auto text-slate-600 mb-12 md:mb-16 text-base md:text-lg px-4">
            Our talented team brings years of expertise and passion to every project, ensuring exceptional results that exceed expectations.
          </p>
            ...
            {["Michael S.", "Emilio A.", "Andrew E."].map((name, i) => (
              <div key={i} className="flex flex-col items-center group">
                <div className="relative bg-gradient-to-b from-emerald-200 to-emerald-50 h-52 w-52 md:h-56 md:w-56 rounded-3xl shadow-lg flex items-end justify-center overflow-hidden transition-all duration-500 group-hover:scale-105 group-hover:shadow-emerald-500/30 group-hover:shadow-2xl">
                  ...
                  <div className="absolute top-4 md:top-6 left-1/2 -translate-x-1/2 w-12 h-12 md:w-14 md:h-14 bg-white rounded-full shadow-md group-hover:scale-110 transition-transform" />
                </div>
      ...
      {/* Contact */}
      <section className="bg-gradient-to-br from-slate-100 via-white to-slate-50 py-16 md:py-24">
        <div className="container mx-auto px-6 md:px-8">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid lg:grid-cols-2 gap-8 md:gap-12">
              ...
              <div className="bg-white rounded-3xl shadow-xl p-8 md:p-10 border border-slate-200">
                <div className="mb-8">
                  <h3 className="text-2xl md:text-3xl font-bold text-slate-900 mb-2">Get in Touch!</h3>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    <label htmlFor="phone" className="block text-sm font-semibold text-slate-700 mb-2">Tel. Number</label>
                    <input
                      id="phone"
                      name="phone"
                      type="tel"
                  ...
                  <div className="group">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <a href="mailto:sales@printfxandsigns.com" className="text-emerald-400 hover:text-emerald-300 transition-colors block">sales@printfxandsigns.com</a>
                        <a href="mailto:printfxandsigns@gmail.com" className="text-emerald-400 hover:text-emerald-300 transition-colors block">printfxandsigns@gmail.com</a>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="group">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <a href="tel:+639083939701" className="text-slate-300 hover:text-white transition-colors">0908 - 3939701</a>
                      </div>
                    </div>
                  </div>
