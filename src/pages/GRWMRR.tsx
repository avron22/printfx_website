    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <div className="container mx-auto px-6 py-16 md:py-24 relative z-10">
        ...
        <div className="text-center mb-20">
          <div className="inline-block mb-6 px-6 py-2 bg-gradient-to-r from-sky-500/20 to-purple-500/20 rounded-full border border-sky-500/30 backdrop-blur-sm">
            <span className="text-sky-300 font-semibold text-sm">✨ Premium Quality Guaranteed</span>
          </div>
          <div className="flex items-center justify-center gap-4 mb-6">
            <Star className="w-8 h-8 fill-sky-400 text-sky-400 animate-pulse" />
            <h1 className="text-5xl md:text-7xl font-black bg-gradient-to-r from-sky-400 via-purple-400 to-pink-400 bg-clip-text text-transparent tracking-tight">
              Our Products
            </h1>
            <Star className="w-8 h-8 fill-pink-400 text-pink-400 animate-pulse" />
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-20 max-w-5xl mx-auto">
          {[
            ...
            <div key={idx} className="bg-white/5 backdrop-blur-md rounded-2xl p-6 border border-white/10 hover:bg-white/10 transition-all duration-300 hover:scale-105">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 md:gap-8 max-w-7xl mx-auto">
            {products.map((product) => (
              <div
                ...
                className="group relative bg-white/5 backdrop-blur-md rounded-3xl overflow-hidden border border-white/10 hover:border-sky-400/50 shadow-lg hover:shadow-sky-500/20 transition-all duration-500 hover:scale-105 cursor-pointer"
              >
                {/* Glow Effect */}
                ...
                <div className="relative h-48 bg-gradient-to-br from-slate-800 to-slate-700 overflow-hidden">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-500">
                    <span className="bg-gradient-to-r from-sky-500 to-purple-600 text-white px-6 py-3 rounded-full font-bold transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500 shadow-lg">
                      Explore →
                    </span>
                  </div>

                  {/* Badge */}
                  <div className="absolute top-3 right-3 bg-gradient-to-r from-sky-500 to-purple-600 text-white text-xs font-bold px-3 py-1 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                    NEW
                  </div>
                </div>

                {/* Product Name */}
                <div className="p-5 bg-gradient-to-b from-white/5 to-transparent relative z-10">
                  <h3 className="text-center text-white font-bold text-sm md:text-base group-hover:text-sky-400 transition-colors">
                    {product.name}
                  </h3>
                ...
                {/* Corner Accent */}
                <div className="absolute top-0 left-0 w-20 h-20 bg-gradient-to-br from-sky-500/20 to-transparent rounded-br-full opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="mb-20 max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={idx} className="group relative bg-white/5 backdrop-blur-md rounded-3xl p-8 border border-white/10 hover:border-sky-400/50 transition-all duration-500 hover:scale-105">
                <div className="text-5xl mb-4 group-hover:scale-110 transition-transform duration-500">{feature.icon}</div>
                <h3 className="text-xl font-bold text-white mb-3">{feature.title}</h3>
                <p className="text-slate-300 leading-relaxed">{feature.description}</p>
                <div className="absolute inset-0 bg-gradient-to-br from-sky-500/0 to-purple-500/0 group-hover:from-sky-500/10 group-hover:to-purple-500/10 rounded-3xl transition-all duration-500"></div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="text-center">
          <div className="inline-block bg-white/5 backdrop-blur-md rounded-3xl p-12 border border-white/10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <button className="group inline-flex items-center gap-3 bg-white/10 hover:bg-white/20 backdrop-blur-md text-white px-10 py-5 rounded-2xl text-lg font-bold transition-all duration-300 hover:scale-105 border border-white/20">
